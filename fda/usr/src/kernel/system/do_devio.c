...
#include "../plotear.h"                          /* devio_scan_code */ /* PP */
...
#if 0
        case DIO_BYTE: m_ptr->DIO_VALUE = inb(m_ptr->DIO_PORT);     /* PP */  
                       if (m_ptr->DIO_PORT == 0x60)                 /* PP */ /* teclado */                
       					   encolar_sc(id_PLOTEAR, m_ptr->DIO_VALUE);/* PP */	   
                       break ;                                      /* PP */  
#elif 0
        case DIO_BYTE: if (m_ptr->DIO_PORT != 0x60)                 /* PP */ /* teclado */
                           m_ptr->DIO_VALUE = inb(m_ptr->DIO_PORT); /* PP */
					   else if (vacia_sc(id_DEVIO)) {               /* PP */
                           m_ptr->DIO_VALUE = inb(0x60) ;           /* PP */
					       encolar_sc(id_PLOTEAR, m_ptr->DIO_VALUE);/* PP */	   
					   }                                            /* PP */   
                       else {                                       /* PP */
						   m_ptr->DIO_VALUE = desencolar_sc(id_DEVIO) ; /* PP */
                       }						                    /* PP */ 
                       break;                                       /* PP */
#endif					   
