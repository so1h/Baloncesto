...
_hwint00:       ! Interrupt routine for irq 0 (the clock).
    ...
    push edx                                                        /* PP */
    o16 push ds
    mov dx, ss      ! ss is kernel data segment                     /* PP */
    mov ds, dx                                                      /* PP */ 
	mov dx,0xE9
	xorb al,al                                                      /* PP */
    outb dx                                       /* >> opINT_00 */ /* PP */
	mov eax,(_clock_ints)                                           /* PP */
    inc eax                                                         /* PP */
    mov (_clock_ints),eax                                           /* PP */
    outb dx                                       /* clock_int 0 */ /* PP */
    ror eax,8                                                       /* PP */
    outb dx                                       /* clock_int 1 */ /* PP */
    ror eax,8                                                       /* PP */
    outb dx                                       /* clock_int 2 */ /* PP */
    ror eax,8                                                       /* PP */
    outb dx                                       /* clock_int 3 */ /* PP */
    o16 push ds                                                     /* PP */
    push edx                                                        /* PP */
    pop eax                                                         /* PP */
    .data2  0xEB08                                                  /* PP */
...
_p_s_call:
    ...
    cmp     ecx,0xB10C00FF      !! plot ?                                   /* PP */
    je      plot_call           !!                                          /* PP */

    cmp     ecx,0xE90000FF      !! e9 ?                                     /* PP */
    je      e9_call             !!                                          /* PP */

	movb al,cl                                                              /* PP */
	addb al,33      /* opSVC_00 + CL */                                     /* PP */ 
	outb 0xE9                                                               /* PP */
    ...
    jmp     seguir              !!                                          /* PP */ 
plot_call:                      !!                                          /* PP */ 
    call    _sys_call_plot      ! sys_call_plot(call_nr, flags, sched, edx) /* PP */
    jmp     seguir                                                          /* PP */ 	
e9_call:                                                                    /* PP */   
    call    _sys_call_e9        ! sys_call_e9(call_nr, flags, sched, edx)   /* PP */	
seguir:                         !!                                          /* PP */
...
exception1:             ! Common for all exceptions.
    ...
    movb al,(ex_number)                                               /* PP */
    addb al,16          ! opEXC_00 + (ex_number)                      /* PP */
    outb 0xE9                                                         /* PP */
    movb al,(trap_errno)                                              /* PP */
    outb 0xE9                                                         /* PP */
